...
namespace PaintDotNet.Effects
{
    internal partial class BuildFileTypeDialog : ChildFormBase
    {
        ...
        private void sourceButton_Click(object sender, EventArgs e)
        {
            ...
            string sourceCode = FileTypeWriter.FullFileTypeSourceCode(this.userCode, this.fileName, this.Author, this.Major, this.Minor, this.URL, this.Description, this.LoadExt, this.SaveExt, this.Layers, this.PluginName);
